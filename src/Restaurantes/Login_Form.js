...
export function Login_Form_Restaurante(props){
    ...
    const butOnClickLOGINUSUARIO = function() {
      navigate("/g5/Login", {
      }) 
    }
    return (
        <section className="gradient-custom h" >
              ...
              <div className="card bg-dark text-white" style={{borderRadius: '1rem'}}>
                <div className="card-body p-5 text-center">
                  <div className="mb-md-5 mt-md-4 pb-5">
                    ...
                    <p className="mb-0">Para cuenta de cliente haz click <a className="text-white-50 fw-bold" onClick={butOnClickLOGINUSUARIO}>Aquí</a>
                    </p>
                    <div>
